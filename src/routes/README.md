...
- `index.tsx` (`/`) is intentionally thin — it only imports and renders
  `Portfolio` from `src/components/sections/Portfolio.tsx`. The actual
  page content, data, styles, and animated backgrounds live outside this
  folder; see the root `README.md` for the full map.
